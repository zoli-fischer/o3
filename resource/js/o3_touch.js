...
(function ( $ ) {
	...
	var w = window, //pointer to window
		...
		touch = typeof w.ontouchstart != 'undefined' || ( typeof window.navigator.pointerEnabled != 'undefined' && window.navigator.pointerEnabled ), //check for touch device
		pointer = window.navigator.pointerEnabled,
		//touch or mouse events needed
		downEvt = touch ? ( pointer ? 'pointerdown' : 'touchstart' ) : 'mousedown',
		upEvt = touch ? ( pointer ? 'pointerup' : 'touchend' ) : 'mouseup',
		moveEvt = touch ? ( pointer ? 'pointermove' : 'touchmove' ) : 'mousemove';
